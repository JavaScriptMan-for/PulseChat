...
router.get('/get-contact/:chat_id', auth_token, contact_controller.get_contact.bind(contact_controller))
router.get('/get-last-messages', auth_token, contact_controller.get_last_messages.bind(contact_controller))
